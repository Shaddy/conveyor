...
// }
//
// pub fn device_open(matches: &ArgMatches, messenger: &Sender<ShellMessage>) -> Result<(), Error> {
//     let name = matches
//         .value_of("name")
...
//         format!(
//             "{} found, handle: {}",
//             style(name).underlined().blue(),
//             style(format!("0x{:x}", handle as u64)).cyan()
//         ),
//         MessageType::Close,
//         1,
//     );
